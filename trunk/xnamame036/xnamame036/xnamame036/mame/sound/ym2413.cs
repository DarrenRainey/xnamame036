...
{
    class ym2413 : Mame.snd_interface
    {
        public ym2413()        
        {
            this.name = "YM-2413";
        ...
        const int ym2413_channels = 9;
        const int ym2413_parameter_count = 12;
        class YM2413_state
        {
            public int rhythm_mode;
            public int pending_register;
            public int[] user_instrument = new int[ym2413_parameter_count];
        }
        static YM2413_state[] ym2413_state = new YM2413_state[Mame.MAX_2413];
        ...
        static int[][] ym2413_instruments =
{
	...
	*/
	new int[]{  0x13,0x11,0x25,0x00,0xd7,0xb7,0xf4,0xf4,0x00,0x00,0x00 },    /* 16 Rhythm 1: */
	new int[]{  0x13,0x11,0x25,0x00,0xd7,0xb7,0xf4,0xf4,0x00,0x00,0x00 },    /* 17 Rhythm 2: */
	new int[]{  0x13,0x11,0x25,0x00,0xd7,0xb7,0xf4,0xf4,0x00,0x00,0x00 },    /* 18 Rhythm 3: */
};
        ...
        {
            YM3812.YM3812_control_port_0_w(0, reg);
            YM3812.YM3812_write_port_0_w(0, data);
        }
        ...
        public static void YM2413_data_port_0_w(int chip, int data)
        {
            ...
            switch (pending)
            {
                ...
                default:
                    Mame.printf("YM2413: Write to register %02x\n", pending);
                    break;
            }
        }
        public static void YM2413_register_port_0_w(int chip, int data)
        {
