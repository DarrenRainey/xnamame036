...
namespace xnamame036.mame
{
    partial class Mame
    {
        public class cpu_m6502 : cpu_6502
        {
            public cpu_m6502()
            {
                cpu_num = CPU_M6502;
        ...
        public class cpu_n2a03 : cpu_6502
        {
            public const double N2A03_DEFAULTCLOCK = (21477272.724 / 12);
            const int N2A03_INT_NONE		=			M6502_INT_NONE;
            const int N2A03_INT_IRQ = M6502_INT_IRQ;
const int N2A03_INT_NMI					=M6502_INT_NMI;
            public cpu_n2a03()
            {
                cpu_num = CPU_N2A03;
                num_irqs = 1;
        ...
        public class cpu_6502 : cpu_interface
        {
            public cpu_6502()
            {
                icount = m6502_ICount;
            ...
            const int
             M6502_PC = 1, M6502_S = 2, M6502_P = 3, M6502_A = 4, M6502_X = 5, M6502_Y = 6,
             M6502_EA = 7, M6502_ZP = 8, M6502_NMI_STATE = 9, M6502_IRQ_STATE = 10, M6502_SO_STATE = 11,
             M6502_SUBTYPE = 12;


            public const int M6502_INT_NONE = 0;
            public const int M6502_INT_IRQ = 1;
            public const int M6502_INT_NMI = 2;
            /* use cpu_set_irq_line(cpu, M6502_SET_OVERFLOW, level)

               to change level of the so input line

               positiv edge sets overflow flag */
            public const int M6502_SET_OVERFLOW = 3;

            public const int M6502_NMI_VEC = 0xfffa;
            public const int M6502_RST_VEC = 0xfffc;
            public const int M6502_IRQ_VEC = 0xfffe;
            /****************************************************************************
            ...
            static void m6502_00() { m6502_ICount[0] -= 7; m6502.pc.wl++; cpu_writemem16((int)m6502.sp.d, (int)m6502.pc.bh); m6502.sp.bl--; cpu_writemem16((int)m6502.sp.d, (int)m6502.pc.bl); m6502.sp.bl--; cpu_writemem16((int)m6502.sp.d, (int)m6502.p | 0x10); m6502.sp.bl--; m6502.p = (byte)((m6502.p | 0x04) & ~0x08); m6502.pc.bl = (byte)cpu_readmem16((int)M6502_IRQ_VEC); m6502.pc.bh = (byte)cpu_readmem16((int)M6502_IRQ_VEC + 1); change_pc16(m6502.pc.d); } /* 7 BRK */
            ...
            static void m6502_80() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            ...
            static void m6502_50() { int tmp; if ((m6502.p & 0x40) == 0) { tmp = cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.wl = (ushort)(m6502.pc.wl + (sbyte)tmp); m6502_ICount[0] -= (m6502.pc.bh == m6502.ea.bh) ? 3 : 4; m6502.pc.d = m6502.ea.d; change_pc16(m6502.pc.d); } else { m6502.pc.wl++; m6502_ICount[0] -= 2; }; } /* 2 BVC REL */
            static void m6502_70() { int tmp; if ((m6502.p & 0x40) != 0) { tmp = cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.wl = (ushort)(m6502.pc.wl + (sbyte)tmp); m6502_ICount[0] -= (m6502.pc.bh == m6502.ea.bh) ? 3 : 4; m6502.pc.d = m6502.ea.d; change_pc16(m6502.pc.d); } else { m6502.pc.wl++; m6502_ICount[0] -= 2; }; } /* 2 BVS REL */
            ...
            static void m6502_61() { int tmp; m6502_ICount[0] -= 6; m6502.zp.bl = (byte)(cpu_readop_arg((uint)m6502.pc.wl++) + m6502.x); m6502.ea.bl = (byte)cpu_readmem16((int)m6502.zp.d); m6502.zp.bl++; m6502.ea.bh = (byte)cpu_readmem16((int)m6502.zp.d); tmp = cpu_readmem16((int)m6502.ea.d); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01); int lo = (m6502.a & 0x0f) + (tmp & 0x0f) + c; int hi = (m6502.a & 0xf0) + (tmp & 0xf0); m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (lo > 0x09) { hi += 0x10; lo += 0x06; } if ((~(m6502.a ^ tmp) & (m6502.a ^ hi) & 0x80) != 0) m6502.p |= 0x40; if (hi > 0x90) hi += 0x60; if ((hi & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 6 ADC IDX */
            ...
            static void m6502_e1() { int tmp; m6502_ICount[0] -= 6; m6502.zp.bl = (byte)(cpu_readop_arg((uint)m6502.pc.wl++) + m6502.x); m6502.ea.bl = (byte)cpu_readmem16((int)m6502.zp.d); m6502.zp.bl++; m6502.ea.bh = (byte)cpu_readmem16((int)m6502.zp.d); tmp = cpu_readmem16((int)m6502.ea.d); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; int lo = (m6502.a & 0x0f) - (tmp & 0x0f) - c; int hi = (m6502.a & 0xf0) - (tmp & 0xf0); m6502.p &= unchecked(((byte)(~(0x40 | 0x01)))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((lo & 0xf0) != 0) lo -= 6; if ((lo & 0x80) != 0) hi -= 0x10; if ((hi & 0x0f00) != 0) hi -= 0x60; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 6 SBC IDX */
            ...
            static void m6502_71() { int tmp; m6502_ICount[0] -= 5; m6502.zp.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bl = (byte)cpu_readmem16((int)m6502.zp.d); m6502.zp.bl++; m6502.ea.bh = (byte)cpu_readmem16((int)m6502.zp.d); if (m6502.ea.bl + m6502.y > 0xff) m6502_ICount[0]--; m6502.ea.wl += m6502.y; tmp = cpu_readmem16((int)m6502.ea.d); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01); int lo = (m6502.a & 0x0f) + (tmp & 0x0f) + c; int hi = (m6502.a & 0xf0) + (tmp & 0xf0); m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (lo > 0x09) { hi += 0x10; lo += 0x06; } if ((~(m6502.a ^ tmp) & (m6502.a ^ hi) & 0x80) != 0) m6502.p |= 0x40; if (hi > 0x90) hi += 0x60; if ((hi & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 5 ADC IDY */
            ...
            static void m6502_f1() { int tmp; m6502_ICount[0] -= 5; m6502.zp.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bl = (byte)cpu_readmem16((int)m6502.zp.d); m6502.zp.bl++; m6502.ea.bh = (byte)cpu_readmem16((int)m6502.zp.d); if (m6502.ea.bl + m6502.y > 0xff) m6502_ICount[0]--; m6502.ea.wl += m6502.y; tmp = cpu_readmem16((int)m6502.ea.d); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; int lo = (m6502.a & 0x0f) - (tmp & 0x0f) - c; int hi = (m6502.a & 0xf0) - (tmp & 0xf0); m6502.p &= unchecked((byte)(~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((lo & 0xf0) != 0) lo -= 6; if ((lo & 0x80) != 0) hi -= 0x10; if ((hi & 0x0f00) != 0) hi -= 0x60; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 5 SBC IDY */

            static void m6502_02() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_22() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_42() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_62() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_82() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            ...
            static void m6502_c2() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_e2() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */

            static void m6502_12() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_32() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_52() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_72() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_92() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_b2() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_d2() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_f2() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */

            static void m6502_03() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_23() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_43() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_63() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_83() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_a3() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_c3() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_e3() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */

            static void m6502_13() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_33() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_53() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_73() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_93() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_b3() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_d3() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_f3() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */

            static void m6502_04() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_24() { int tmp; m6502_ICount[0] -= 3; m6502.zp.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.d = m6502.zp.d; tmp = cpu_readmem16((int)m6502.ea.d); m6502.p &= unchecked((byte)~(0x80 | 0x40 | 0x02)); m6502.p |= (byte)(tmp & (0x80 | 0x40)); if ((tmp & m6502.a) == 0) m6502.p |= 0x02; } /* 3 BIT ZPG */
            static void m6502_44() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_64() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            ...
            static void m6502_14() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_34() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_54() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_74() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            ...
            static void m6502_d4() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_f4() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            ...
            static void m6502_65() { int tmp; m6502_ICount[0] -= 3; m6502.zp.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.d = m6502.zp.d; tmp = cpu_readmem16((int)m6502.ea.d); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01); int lo = (m6502.a & 0x0f) + (tmp & 0x0f) + c; int hi = (m6502.a & 0xf0) + (tmp & 0xf0); m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (lo > 0x09) { hi += 0x10; lo += 0x06; } if ((~(m6502.a ^ tmp) & (m6502.a ^ hi) & 0x80) != 0) m6502.p |= 0x40; if (hi > 0x90) hi += 0x60; if ((hi & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 3 ADC ZPG */
            ...
            static void m6502_e5() { int tmp; m6502_ICount[0] -= 3; m6502.zp.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.d = m6502.zp.d; tmp = cpu_readmem16((int)m6502.ea.d); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; int lo = (m6502.a & 0x0f) - (tmp & 0x0f) - c; int hi = (m6502.a & 0xf0) - (tmp & 0xf0); m6502.p &= unchecked((byte)(~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((lo & 0xf0) != 0) lo -= 6; if ((lo & 0x80) != 0) hi -= 0x10; if ((hi & 0x0f00) != 0) hi -= 0x60; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 3 SBC ZPG */
            ...
            static void m6502_75() { int tmp; m6502_ICount[0] -= 4; m6502.zp.bl = (byte)(cpu_readop_arg((uint)m6502.pc.wl++) + m6502.x); m6502.ea.d = m6502.zp.d; tmp = cpu_readmem16((int)m6502.ea.d); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01); int lo = (m6502.a & 0x0f) + (tmp & 0x0f) + c; int hi = (m6502.a & 0xf0) + (tmp & 0xf0); m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (lo > 0x09) { hi += 0x10; lo += 0x06; } if ((~(m6502.a ^ tmp) & (m6502.a ^ hi) & 0x80) != 0) m6502.p |= 0x40; if (hi > 0x90) hi += 0x60; if ((hi & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 ADC ZPX */
            ...
            static void m6502_f5() { int tmp; m6502_ICount[0] -= 4; m6502.zp.bl = (byte)(cpu_readop_arg((uint)m6502.pc.wl++) + m6502.x); m6502.ea.d = m6502.zp.d; tmp = cpu_readmem16((int)m6502.ea.d); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; int lo = (m6502.a & 0x0f) - (tmp & 0x0f) - c; int hi = (m6502.a & 0xf0) - (tmp & 0xf0); m6502.p &= unchecked((byte)(~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((lo & 0xf0) != 0) lo -= 6; if ((lo & 0x80) != 0) hi -= 0x10; if ((hi & 0x0f00) != 0) hi -= 0x60; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 SBC ZPX */
            ...
            static void m6502_07() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_27() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_47() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_67() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_87() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_a7() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_c7() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_e7() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */

            static void m6502_17() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_37() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_57() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_77() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_97() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_b7() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_d7() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_f7() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            ...
            static void m6502_b8() { m6502_ICount[0] -= 2; m6502.p &= unchecked((byte)~0x40); } /* 2 CLV */
            ...
            static void m6502_69() { int tmp; m6502_ICount[0] -= 2; tmp = cpu_readop_arg((uint)m6502.pc.wl++); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01); int lo = (m6502.a & 0x0f) + (tmp & 0x0f) + c; int hi = (m6502.a & 0xf0) + (tmp & 0xf0); m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (lo > 0x09) { hi += 0x10; lo += 0x06; } if ((~(m6502.a ^ tmp) & (m6502.a ^ hi) & 0x80) != 0) m6502.p |= 0x40; if (hi > 0x90) hi += 0x60; if ((hi & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 2 ADC IMM */
            static void m6502_89() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            ...
            static void m6502_e9() { int tmp; m6502_ICount[0] -= 2; tmp = cpu_readop_arg((uint)m6502.pc.wl++); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; int lo = (m6502.a & 0x0f) - (tmp & 0x0f) - c; int hi = (m6502.a & 0xf0) - (tmp & 0xf0); m6502.p &= unchecked((byte)(~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((lo & 0xf0) != 0) lo -= 6; if ((lo & 0x80) != 0) hi -= 0x10; if ((hi & 0x0f00) != 0) hi -= 0x60; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 2 SBC IMM */
            ...
            static void m6502_79() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.wl += m6502.y; tmp = cpu_readmem16((int)m6502.ea.d); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01); int lo = (m6502.a & 0x0f) + (tmp & 0x0f) + c; int hi = (m6502.a & 0xf0) + (tmp & 0xf0); m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (lo > 0x09) { hi += 0x10; lo += 0x06; } if ((~(m6502.a ^ tmp) & (m6502.a ^ hi) & 0x80) != 0) m6502.p |= 0x40; if (hi > 0x90) hi += 0x60; if ((hi & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 ADC ABY */
            ...
            static void m6502_f9() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.wl += m6502.y; tmp = cpu_readmem16((int)m6502.ea.d); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; int lo = (m6502.a & 0x0f) - (tmp & 0x0f) - c; int hi = (m6502.a & 0xf0) - (tmp & 0xf0); m6502.p &= unchecked((byte)(~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((lo & 0xf0) != 0) lo -= 6; if ((lo & 0x80) != 0) hi -= 0x10; if ((hi & 0x0f00) != 0) hi -= 0x60; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 SBC ABY */
            ...
            static void m6502_1a() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_3a() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_5a() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_7a() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            ...
            static void m6502_da() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_fa() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */

            static void m6502_0b() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_2b() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_4b() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_6b() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_8b() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_ab() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_cb() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_eb() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */

            static void m6502_1b() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_3b() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_5b() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_7b() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_9b() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_bb() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_db() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_fb() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */

            static void m6502_0c() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_2c() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); tmp = cpu_readmem16((int)m6502.ea.d); m6502.p &= unchecked((byte)~(0x80 | 0x40 | 0x02)); m6502.p |= (byte)(tmp & (0x80 | 0x40)); if ((tmp & m6502.a) == 0) m6502.p |= 0x02; } /* 4 BIT ABS */
            ...
            static void m6502_6c() { int tmp; m6502_ICount[0] -= 5; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); tmp = cpu_readmem16((int)m6502.ea.d); m6502.ea.bl++; m6502.ea.bh = (byte)cpu_readmem16((int)m6502.ea.d); m6502.ea.bl = (byte)tmp; if (m6502.ea.d == m6502.ppc.d && m6502.pending_irq == 0 && m6502.after_cli == 0) if (m6502_ICount[0] > 0) m6502_ICount[0] = 0; m6502.pc.d = m6502.ea.d; change_pc16(m6502.pc.d); } /* 5 JMP IND */
            ...
            static void m6502_1c() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_3c() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_5c() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_7c() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_9c() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            ...
            static void m6502_dc() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_fc() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            ...
            static void m6502_6d() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); tmp = cpu_readmem16((int)m6502.ea.d); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01); int lo = (m6502.a & 0x0f) + (tmp & 0x0f) + c; int hi = (m6502.a & 0xf0) + (tmp & 0xf0); m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (lo > 0x09) { hi += 0x10; lo += 0x06; } if ((~(m6502.a ^ tmp) & (m6502.a ^ hi) & 0x80) != 0) m6502.p |= 0x40; if (hi > 0x90) hi += 0x60; if ((hi & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 ADC ABS */
            ...
            static void m6502_ed() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); tmp = cpu_readmem16((int)m6502.ea.d); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; int lo = (m6502.a & 0x0f) - (tmp & 0x0f) - c; int hi = (m6502.a & 0xf0) - (tmp & 0xf0); m6502.p &=unchecked((byte)(~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((lo & 0xf0) != 0) lo -= 6; if ((lo & 0x80) != 0) hi -= 0x10; if ((hi & 0x0f00) != 0) hi -= 0x60; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &=unchecked((byte)unchecked((byte) ~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 SBC ABS */
            ...
            static void m6502_7d() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.wl += m6502.x; tmp = cpu_readmem16((int)m6502.ea.d); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01); int lo = (m6502.a & 0x0f) + (tmp & 0x0f) + c; int hi = (m6502.a & 0xf0) + (tmp & 0xf0); m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (lo > 0x09) { hi += 0x10; lo += 0x06; } if ((~(m6502.a ^ tmp) & (m6502.a ^ hi) & 0x80) != 0) m6502.p |= 0x40; if (hi > 0x90) hi += 0x60; if ((hi & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 ADC ABX */
            ...
            static void m6502_fd() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.wl += m6502.x; tmp = cpu_readmem16((int)m6502.ea.d); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; int lo = (m6502.a & 0x0f) - (tmp & 0x0f) - c; int hi = (m6502.a & 0xf0) - (tmp & 0xf0); m6502.p &= unchecked((byte)(~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((lo & 0xf0) != 0) lo -= 6; if ((lo & 0x80) != 0) hi -= 0x10; if ((hi & 0x0f00) != 0) hi -= 0x60; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 SBC ABX */
            ...
            static void m6502_9e() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            ...
            static void m6502_0f() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_2f() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_4f() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_6f() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_8f() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_af() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_cf() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_ef() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */

            static void m6502_1f() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_3f() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_5f() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_7f() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_9f() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_bf() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_df() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
            static void m6502_ff() { m6502_ICount[0] -= 2; throw new Exception("Illegal opcode"); ; } /* 2 ILL */
 ...
 m6502_f8,m6502_f9,m6502_fa,m6502_fb,m6502_fc,m6502_fd,m6502_fe,m6502_ff
            ...
            static void m65c02_34() { int tmp; m6502_ICount[0] -= 4; m6502.zp.bl = (byte)(cpu_readop_arg((uint)m6502.pc.wl++) + m6502.x); m6502.ea.d = m6502.zp.d; tmp = cpu_readmem16((int)m6502.ea.d); m6502.p &= unchecked((byte)~(0x80 | 0x40 | 0x02)); m6502.p |= (byte)(tmp & (0x80 | 0x40)); if ((tmp & m6502.a) == 0) m6502.p |= 0x02; } /* 4 BIT ZPX */
            ...
            static void m65c02_89() { int tmp; m6502_ICount[0] -= 2; tmp = cpu_readop_arg((uint)m6502.pc.wl++); m6502.p &= unchecked((byte)~(0x80 | 0x40 | 0x02)); m6502.p |= (byte)(tmp & (0x80 | 0x40)); if ((tmp & m6502.a) == 0) m6502.p |= 0x02; } /* 2 BIT IMM */
            ...
            static void m65c02_3c() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.wl += m6502.x; tmp = cpu_readmem16((int)m6502.ea.d); m6502.p &= unchecked((byte)~(0x80 | 0x40 | 0x02)); m6502.p |= (byte)(tmp & (0x80 | 0x40)); if ((tmp & m6502.a) == 0) m6502.p |= 0x02; } /* 4 BIT ABX */

            static void m65c02_7c() { int tmp; m6502_ICount[0] -= 2; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); tmp = cpu_readmem16((int)m6502.ea.d); m6502.ea.bl++; m6502.ea.bh = (byte)cpu_readmem16((int)m6502.ea.d); m6502.ea.bl = (byte)tmp; if (m6502.ea.bl + m6502.x > 0xff) m6502_ICount[0]--; m6502.ea.wl += m6502.x; if (m6502.ea.d == m6502.ppc.d && m6502.pending_irq == 0 && m6502.after_cli == 0) if (m6502_ICount[0] > 0) m6502_ICount[0] = 0; m6502.pc.d = m6502.ea.d; change_pc16(m6502.pc.d); } /* 6 JMP IAX */
 ...
 m6502_f8,m6502_f9,m65c02_fa,m6502_fb,m6502_fc,m6502_fd,m6502_fe,m65c02_ff
            ...
            static void m6510_63() { int tmp; m6502_ICount[0] -= 7; m6502.zp.bl = (byte)(cpu_readop_arg((uint)m6502.pc.wl++) + m6502.x); m6502.ea.bl = (byte)cpu_readmem16((int)m6502.zp.d); m6502.zp.bl++; m6502.ea.bh = (byte)cpu_readmem16((int)m6502.zp.d); tmp = cpu_readmem16((int)m6502.ea.d); tmp |= (m6502.p & 0x01) << 8; m6502.p = (byte)((m6502.p & ~0x01) | (tmp & 0x01)); tmp = (byte)(tmp >> 1); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01); int lo = (m6502.a & 0x0f) + (tmp & 0x0f) + c; int hi = (m6502.a & 0xf0) + (tmp & 0xf0); m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if (lo > 0x09) { hi += 0x10; lo += 0x06; } if ((~(m6502.a ^ tmp) & (m6502.a ^ hi) & 0x80) != 0) m6502.p |= 0x40; if (hi > 0x90) hi += 0x60; if ((hi & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); cpu_writemem16((int)m6502.ea.d, (int)tmp); } /* 6 RRA IDX */
            ...
            static void m6510_e3() { int tmp; m6502_ICount[0] -= 7; m6502.zp.bl = (byte)(cpu_readop_arg((uint)m6502.pc.wl++) + m6502.x); m6502.ea.bl = (byte)cpu_readmem16((int)m6502.zp.d); m6502.zp.bl++; m6502.ea.bh = (byte)cpu_readmem16((int)m6502.zp.d); tmp = cpu_readmem16((int)m6502.ea.d); tmp = (byte)++tmp; if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; int lo = (m6502.a & 0x0f) - (tmp & 0x0f) - c; int hi = (m6502.a & 0xf0) - (tmp & 0xf0); m6502.p &= unchecked((byte)(~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((lo & 0xf0) != 0) lo -= 6; if ((lo & 0x80) != 0) hi -= 0x10; if ((hi & 0x0f00) != 0) hi -= 0x60; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); cpu_writemem16((int)m6502.ea.d, (int)tmp); } /* 7 ISB IDX */
            ...
            static void m6510_f3() { int tmp; m6502_ICount[0] -= 6; m6502.zp.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bl = (byte)cpu_readmem16((int)m6502.zp.d); m6502.zp.bl++; m6502.ea.bh = (byte)cpu_readmem16((int)m6502.zp.d); if (m6502.ea.bl + m6502.y > 0xff) m6502_ICount[0]--; m6502.ea.wl += m6502.y; tmp = cpu_readmem16((int)m6502.ea.d); tmp = (byte)++tmp; if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; int lo = (m6502.a & 0x0f) - (tmp & 0x0f) - c; int hi = (m6502.a & 0xf0) - (tmp & 0xf0); m6502.p &= unchecked((byte)(~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((lo & 0xf0) != 0) lo -= 6; if ((lo & 0x80) != 0) hi -= 0x10; if ((hi & 0x0f00) != 0) hi -= 0x60; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &=unchecked((byte)unchecked((byte) ~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); cpu_writemem16((int)m6502.ea.d, (int)tmp); } /* 6 ISB IDY */
            ...
            static void m6510_67() { int tmp; m6502_ICount[0] -= 5; m6502.zp.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.d = m6502.zp.d; tmp = cpu_readmem16((int)m6502.ea.d); tmp |= (m6502.p & 0x01) << 8; m6502.p = (byte)((m6502.p & ~0x01) | (tmp & 0x01)); tmp = (byte)(tmp >> 1); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01); int lo = (m6502.a & 0x0f) + (tmp & 0x0f) + c; int hi = (m6502.a & 0xf0) + (tmp & 0xf0); m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (lo > 0x09) { hi += 0x10; lo += 0x06; } if ((~(m6502.a ^ tmp) & (m6502.a ^ hi) & 0x80) != 0) m6502.p |= 0x40; if (hi > 0x90) hi += 0x60; if ((hi & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); cpu_writemem16((int)m6502.ea.d, (int)tmp); } /* 5 RRA ZPG */
            ...
            static void m6510_e7() { int tmp; m6502_ICount[0] -= 5; m6502.zp.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.d = m6502.zp.d; tmp = cpu_readmem16((int)m6502.ea.d); tmp = (byte)++tmp; if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; int lo = (m6502.a & 0x0f) - (tmp & 0x0f) - c; int hi = (m6502.a & 0xf0) - (tmp & 0xf0); m6502.p &= unchecked((byte)(~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((lo & 0xf0) != 0) lo -= 6; if ((lo & 0x80) != 0) hi -= 0x10; if ((hi & 0x0f00) != 0) hi -= 0x60; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); cpu_writemem16((int)m6502.ea.d, (int)tmp); } /* 5 ISB ZPG */
            ...
            static void m6510_77() { int tmp; m6502_ICount[0] -= 6; m6502.zp.bl = (byte)(cpu_readop_arg((uint)m6502.pc.wl++) + m6502.x); m6502.ea.d = m6502.zp.d; tmp = cpu_readmem16((int)m6502.ea.d); tmp |= (m6502.p & 0x01) << 8; m6502.p = (byte)((m6502.p & ~0x01) | (tmp & 0x01)); tmp = (byte)(tmp >> 1); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01); int lo = (m6502.a & 0x0f) + (tmp & 0x0f) + c; int hi = (m6502.a & 0xf0) + (tmp & 0xf0); m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (lo > 0x09) { hi += 0x10; lo += 0x06; } if ((~(m6502.a ^ tmp) & (m6502.a ^ hi) & 0x80) != 0) m6502.p |= 0x40; if (hi > 0x90) hi += 0x60; if ((hi & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); cpu_writemem16((int)m6502.ea.d, (int)tmp); } /* 4 RRA ZPX */
            ...
            static void m6510_f7() { int tmp; m6502_ICount[0] -= 6; m6502.zp.bl = (byte)(cpu_readop_arg((uint)m6502.pc.wl++) + m6502.x); m6502.ea.d = m6502.zp.d; tmp = cpu_readmem16((int)m6502.ea.d); tmp = (byte)++tmp; if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; int lo = (m6502.a & 0x0f) - (tmp & 0x0f) - c; int hi = (m6502.a & 0xf0) - (tmp & 0xf0); m6502.p &= unchecked((byte)(~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((lo & 0xf0) != 0) lo -= 6; if ((lo & 0x80) != 0) hi -= 0x10; if ((hi & 0x0f00) != 0) hi -= 0x60; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); cpu_writemem16((int)m6502.ea.d, (int)tmp); } /* 6 ISB ZPX */
            ...
            static void m6510_7b() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.wl += m6502.y; tmp = cpu_readmem16((int)m6502.ea.d); tmp |= (m6502.p & 0x01) << 8; m6502.p = (byte)((m6502.p & ~0x01) | (tmp & 0x01)); tmp = (byte)(tmp >> 1); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01); int lo = (m6502.a & 0x0f) + (tmp & 0x0f) + c; int hi = (m6502.a & 0xf0) + (tmp & 0xf0); m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (lo > 0x09) { hi += 0x10; lo += 0x06; } if ((~(m6502.a ^ tmp) & (m6502.a ^ hi) & 0x80) != 0) m6502.p |= 0x40; if (hi > 0x90) hi += 0x60; if ((hi & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 RRA ABY */
            ...
            static void m6510_fb() { int tmp; m6502_ICount[0] -= 6; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.wl += m6502.y; tmp = cpu_readmem16((int)m6502.ea.d); tmp = (byte)++tmp; if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; int lo = (m6502.a & 0x0f) - (tmp & 0x0f) - c; int hi = (m6502.a & 0xf0) - (tmp & 0xf0); m6502.p &= unchecked((byte)(~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((lo & 0xf0) != 0) lo -= 6; if ((lo & 0x80) != 0) hi -= 0x10; if ((hi & 0x0f00) != 0) hi -= 0x60; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); cpu_writemem16((int)m6502.ea.d, (int)tmp); } /* 6 ISB ABY */
            ...
            static void m6510_6f() { int tmp; m6502_ICount[0] -= 6; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); tmp = cpu_readmem16((int)m6502.ea.d); tmp |= (m6502.p & 0x01) << 8; m6502.p = (byte)((m6502.p & ~0x01) | (tmp & 0x01)); tmp = (byte)(tmp >> 1); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01); int lo = (m6502.a & 0x0f) + (tmp & 0x0f) + c; int hi = (m6502.a & 0xf0) + (tmp & 0xf0); m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (lo > 0x09) { hi += 0x10; lo += 0x06; } if ((~(m6502.a ^ tmp) & (m6502.a ^ hi) & 0x80) != 0) m6502.p |= 0x40; if (hi > 0x90) hi += 0x60; if ((hi & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); cpu_writemem16((int)m6502.ea.d, (int)tmp); } /* 4 RRA ABS */
            ...
            static void m6510_ef() { int tmp; m6502_ICount[0] -= 6; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); tmp = cpu_readmem16((int)m6502.ea.d); tmp = (byte)++tmp; if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; int lo = (m6502.a & 0x0f) - (tmp & 0x0f) - c; int hi = (m6502.a & 0xf0) - (tmp & 0xf0); m6502.p &= unchecked((byte)(~(0x40 | 0x01))); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((lo & 0xf0) != 0) lo -= 6; if ((lo & 0x80) != 0) hi -= 0x10; if ((hi & 0x0f00) != 0) hi -= 0x60; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); cpu_writemem16((int)m6502.ea.d, (int)tmp); } /* 6 ISB ABS */
            ...
            static void m6510_7f() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.wl += m6502.x; tmp = cpu_readmem16((int)m6502.ea.d); tmp |= (m6502.p & 0x01) << 8; m6502.p = (byte)((m6502.p & ~0x01) | (tmp & 0x01)); tmp = (byte)(tmp >> 1); if ((m6502.p & 0x08) != 0) { int c = (m6502.p & 0x01); int lo = (m6502.a & 0x0f) + (tmp & 0x0f) + c; int hi = (m6502.a & 0xf0) + (tmp & 0xf0); m6502.p &= unchecked((byte)~(0x40 | 0x01)); if (lo > 0x09) { hi += 0x10; lo += 0x06; } if ((~(m6502.a ^ tmp) & (m6502.a ^ hi) & 0x80) != 0) m6502.p |= 0x40; if (hi > 0x90) hi += 0x60; if ((hi & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)((lo & 0x0f) + (hi & 0xf0)); } else { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &= unchecked((byte)~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); cpu_writemem16((int)m6502.ea.d, (int)tmp); } /* 4 RRA ABX */
 ...
 m6502_f8,m6502_f9,m6510_fa,m6510_fb,m6510_fc,m6502_fd,m6502_fe,m6510_ff
            ...
            static void n2a03_61() { int tmp; m6502_ICount[0] -= 6; m6502.zp.bl = (byte)(cpu_readop_arg((uint)m6502.pc.wl++) + m6502.x); m6502.ea.bl = (byte)cpu_readmem16((int)m6502.zp.d); m6502.zp.bl++; m6502.ea.bh = (byte)cpu_readmem16((int)m6502.zp.d); tmp = cpu_readmem16((int)m6502.ea.d); { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 6 ADC IDX */



            static void n2a03_e1() { int tmp; m6502_ICount[0] -= 6; m6502.zp.bl = (byte)(cpu_readop_arg((uint)m6502.pc.wl++) + m6502.x); m6502.ea.bl = (byte)cpu_readmem16((int)m6502.zp.d); m6502.zp.bl++; m6502.ea.bh = (byte)cpu_readmem16((int)m6502.zp.d); tmp = cpu_readmem16((int)m6502.ea.d); { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 6 SBC IDX */




            static void n2a03_71() { int tmp; m6502_ICount[0] -= 5; m6502.zp.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bl = (byte)cpu_readmem16((int)m6502.zp.d); m6502.zp.bl++; m6502.ea.bh = (byte)cpu_readmem16((int)m6502.zp.d); if (m6502.ea.bl + m6502.y > 0xff) m6502_ICount[0]--; m6502.ea.wl += m6502.y; tmp = cpu_readmem16((int)m6502.ea.d); { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 5 ADC IDY */



            static void n2a03_f1() { int tmp; m6502_ICount[0] -= 5; m6502.zp.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bl = (byte)cpu_readmem16((int)m6502.zp.d); m6502.zp.bl++; m6502.ea.bh = (byte)cpu_readmem16((int)m6502.zp.d); if (m6502.ea.bl + m6502.y > 0xff) m6502_ICount[0]--; m6502.ea.wl += m6502.y; tmp = cpu_readmem16((int)m6502.ea.d); { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 5 SBC IDY */
            static void n2a03_65() { int tmp; m6502_ICount[0] -= 3; m6502.zp.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.d = m6502.zp.d; tmp = cpu_readmem16((int)m6502.ea.d); { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 3 ADC ZPG */



            static void n2a03_e5() { int tmp; m6502_ICount[0] -= 3; m6502.zp.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.d = m6502.zp.d; tmp = cpu_readmem16((int)m6502.ea.d); { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 3 SBC ZPG */




            static void n2a03_75() { int tmp; m6502_ICount[0] -= 4; m6502.zp.bl = (byte)(cpu_readop_arg((uint)m6502.pc.wl++) + m6502.x); m6502.ea.d = m6502.zp.d; tmp = cpu_readmem16((int)m6502.ea.d); { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 ADC ZPX */



            static void n2a03_f5() { int tmp; m6502_ICount[0] -= 4; m6502.zp.bl = (byte)(cpu_readop_arg((uint)m6502.pc.wl++) + m6502.x); m6502.ea.d = m6502.zp.d; tmp = cpu_readmem16((int)m6502.ea.d); { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 SBC ZPX */
            static void n2a03_69() { int tmp; m6502_ICount[0] -= 2; tmp = cpu_readop_arg((uint)m6502.pc.wl++); { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 2 ADC IMM */



            static void n2a03_e9() { int tmp; m6502_ICount[0] -= 2; tmp = cpu_readop_arg((uint)m6502.pc.wl++); { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 2 SBC IMM */




            static void n2a03_79() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.wl += m6502.y; tmp = cpu_readmem16((int)m6502.ea.d); { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 ADC ABY */



            static void n2a03_f9() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.wl += m6502.y; tmp = cpu_readmem16((int)m6502.ea.d); { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 SBC ABY */
            static void n2a03_6d() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); tmp = cpu_readmem16((int)m6502.ea.d); { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 ADC ABS */



            static void n2a03_ed() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); tmp = cpu_readmem16((int)m6502.ea.d); { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 SBC ABS */




            static void n2a03_7d() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.wl += m6502.x; tmp = cpu_readmem16((int)m6502.ea.d); { int c = (m6502.p & 0x01); int sum = m6502.a + tmp + c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if ((~(m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) != 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 ADC ABX */



            static void n2a03_fd() { int tmp; m6502_ICount[0] -= 4; m6502.ea.bl = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.bh = (byte)cpu_readop_arg((uint)m6502.pc.wl++); m6502.ea.wl += m6502.x; tmp = cpu_readmem16((int)m6502.ea.d); { int c = (m6502.p & 0x01) ^ 0x01; int sum = m6502.a - tmp - c; m6502.p &=unchecked((byte) ~(0x40 | 0x01)); if (((m6502.a ^ tmp) & (m6502.a ^ sum) & 0x80) != 0) m6502.p |= 0x40; if ((sum & 0xff00) == 0) m6502.p |= 0x01; m6502.a = (byte)sum; } if ((m6502.a) == 0) m6502.p = (byte)((m6502.p & ~0x80) | 0x02); else m6502.p = (byte)((m6502.p & ~(0x80 | 0x02)) | ((m6502.a) & 0x80)); } /* 4 SBC ABX */
 ...
 m6502_f8,n2a03_f9,m6502_fa,m6502_fb,m6502_fc,n2a03_fd,m6502_fe,m6502_ff
            ...
            void m6502_reset(object param)
            {
                ...
                m6502.pc.bl = (byte)cpu_readmem16((int)M6502_RST_VEC);
                m6502.pc.bh = (byte)cpu_readmem16((int)M6502_RST_VEC + 1);
            ...
            uint m6502_get_reg(int regnum)
            {
                switch (regnum)
                {
                    case M6502_PC: return m6502.pc.wl;
                    case M6502_S: return m6502.sp.bl;
                    case M6502_P: return m6502.p;
                    case M6502_A: return m6502.a;
                    case M6502_X: return m6502.x;
                    case M6502_Y: return m6502.y;
                    case M6502_EA: return m6502.ea.wl;
                    case M6502_ZP: return m6502.zp.wl;
                    ...
                    case REG_PREVIOUSPC: return m6502.ppc.wl;
                    default:
                        if (regnum <= REG_SP_CONTENTS)
                        {
                            uint offset = (uint)(m6502.sp.bl + 2 * (REG_SP_CONTENTS - regnum));
                            if (offset < 0x1ff)
            ...
            void m6502_set_reg(int regnum, uint val)
            {
                switch (regnum)
                {
                    case M6502_PC: m6502.pc.wl = (ushort)val; break;
                    case M6502_S: m6502.sp.bl = (byte)val; break;
                    case M6502_P: m6502.p = (byte)val; break;
                    case M6502_A: m6502.a = (byte)val; break;
                    case M6502_X: m6502.x = (byte)val; break;
                    case M6502_Y: m6502.y = (byte)val; break;
                    case M6502_EA: m6502.ea.wl =(ushort) val; break;
                    case M6502_ZP: m6502.zp.wl =(ushort) val; break;
                    case M6502_NMI_STATE: m6502_set_nmi_line((int)val); break;
                    case M6502_IRQ_STATE: m6502_set_irq_line(0, (int)val); break;
                    case M6502_SO_STATE: m6502_set_irq_line(M6502_SET_OVERFLOW, (int)val); break;
                    default:
                        if (regnum <= REG_SP_CONTENTS)
                        {
                            uint offset = (uint)(m6502.sp.bl + 2 * (REG_SP_CONTENTS - regnum));
                            if (offset < 0x1ff)
                            {
                                cpu_writemem16((int)offset, (int)val & 0xfff);
                                cpu_writemem16((int)offset + 1, (int)(val >> 8) & 0xff);
                            }
                        }
                        break;
                }
            ...
            static void take_irq()
            {
                if ((m6502.p & 0x04) == 0)
                {
                    m6502.ea.d = M6502_IRQ_VEC;
                    m6502_ICount[0] -= 7;
            ...
            uint m6502_dasm(ref string buffer, uint pc)
            {
            ...
            uint m65c02_get_reg(int regnum) { return m6502_get_reg(regnum); }
            void m65c02_set_reg(int regnum, uint val) { m6502_set_reg(regnum, val); }
            ...
            uint m65c02_dasm(ref string buffer, uint pc)
            {
            ...
            uint m65sc02_get_reg(int regnum) { return m6502_get_reg(regnum); }
            void m65sc02_set_reg(int regnum, uint val) { m6502_set_reg(regnum, val); }
            ...
            uint m65sc02_dasm(ref string buffer, uint pc)
            {
            ...
            uint m6510_get_reg(int regnum) { return m6502_get_reg(regnum); }
            void m6510_set_reg(int regnum, uint val) { m6502_set_reg(regnum, val); }
            ...
            uint m6510_dasm(ref string buffer, uint pc)
            {
            ...
            uint n2a03_get_reg(int regnum) { return m6502_get_reg(regnum); }
            void n2a03_set_reg(int regnum, uint val) { m6502_set_reg(regnum, val); }
            ...
            uint n2a03_dasm(ref string buffer, uint pc)
            {
