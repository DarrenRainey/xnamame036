...
namespace xnamame036.mame
{
    class Slapstic
    {
        class slapstic_params
        {
            public uint reset;
            public uint bank0, bank1, bank2, bank3;
            public uint disable;
            public uint ignore;
            public uint senable;
            public uint sbank0, sbank1, sbank2, sbank3;
            public slapstic_params(uint reset, uint bank0, uint bank1, uint bank2, uint bank3, uint disable, uint ignore, uint senable, uint sbank0, uint sbank1, uint sbank2, uint sbank3)
            {
                this.reset = reset;
                this.bank0 = bank0; this.bank1 = bank1; this.bank2 = bank2; this.bank3 = bank3;
                this.disable = disable; this.ignore = ignore; this.senable = senable;
                this.sbank0 = sbank0; this.sbank1 = sbank1; this.sbank2 = sbank2; this.sbank3 = sbank3;
            }
        };
...
/* EC990622 end of Rampart fix */
        ...
        const uint DISABLE_MASK = 0x3ff0;
        const uint IGNORE_MASK = 0x007f;
        const uint UNKNOWN = 0xffff;
        const byte ENABLED = 0, DISABLED = 1, IGNORE = 2, SPECIAL = 3;

        static slapstic_params slapstic;
        static byte state;
        static sbyte next_bank, extra_bank, current_bank;
        static byte version;
        ...
        public static void slapstic_reset() { slapstic_init(version); }
